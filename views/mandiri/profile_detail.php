	<div class="artikel">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form">
			...
			<tr>
				<td colspan="3" class="button" scope="col"><a href="<?php echo esc_url(add_query_arg('print', 'kartu_keluarga', $mandiri_page)) ?>" target="_blank">
			...
			<tr>
				<td><?php  echo ucwords($setting['sebutan_dusun'])?></td>
				<td>:</td>
			...
			<tr>
				<td colspan="3" class="button" scope="col"><a href="<?php echo esc_url(add_query_arg('print', 'biodata', $mandiri_page)) ?>" target="_blank">
